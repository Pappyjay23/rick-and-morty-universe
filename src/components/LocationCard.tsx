    ...
    return (
        <>
            <div
                ...
                className="relative cursor-pointer block  flex-shrink-0 scale-[.85] hover:scale-[.95] duration-500 bg-[#222935] rounded-[10px] h-[300px] lg:h-[400px] w-[150px] lg:w-[250px]"
            >
                <div className="bg-black/70 h-[300px] lg:h-[400px] w-[150px] lg:w-[250px] absolute rounded-[10px]"></div>
                <img
                    src={LocationBg}
                    alt="Movie"
                    className=" h-[300px] lg:h-[400px] w-[150px] lg:w-[250px] object-cover rounded-[10px]"
                />
